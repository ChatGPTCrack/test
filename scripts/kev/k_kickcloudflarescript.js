...
heading.innerHTML = `<h1 class="zone-name-title h1"><img src="https://github.com/ChatGPTCrack/test/raw/refs/heads/main/images/kick/favicon.ico" class="heading-favicon" alt="Icon">` + nig + `</h1>`;
